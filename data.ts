...
export const proarc: Iproarc[] = [
    ...
    },
    {
        ...
        description: "2014-2015 <br/><br/>(To be added)",
        image_path: "/images/0.jpg",
        deployed_url: "",
        category: ["Student Projects"],
        key_techs: ["Taiwan", "Master Plan Review"],
    },
    {
        id: 20,
        name: "Light Up Shisizhang Development Plan",
        description: "2015-2016 <br/><br/>(To be added)",
        image_path: "/images/0.jpg",
        deployed_url: "",
        category: ["Student Projects"],
    ...
    },
    {
        ...
        description: "2018 <br/><br/>(To be added)",
    ...
    },
    {
        ...
        description: "2019 <br/><br/>(To be added)",
    ...
    },
    {
        ...
        description: "2019-2020 <br/><br/>(To be added)",
